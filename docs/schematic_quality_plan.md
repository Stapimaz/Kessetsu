...
- [ ] SQ-9 — Lock accepted corpus metrics/hashes/screenshots and run canonical local/remote verification. _Candidate hashes/scorecard are regression-locked and the complete local `scripts/verify.ps1` gate passed on 2026-08-14; the pushed commit's remote CI result remains pending._
...
The rejected 2026-08-13 candidate remains as historical evidence in `docs/evals/schematic-quality-candidate-2026-08-13.md`. The replacement candidate is recorded in `docs/evals/schematic-quality-candidate-2026-08-14.md`. SQ-9's remote gate and SQ-10 remain release blockers; the new candidate deliberately does not imply owner acceptance or Phase 4 visual closure yet.
